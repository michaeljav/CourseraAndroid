...
public class ContactoAdaptador  extends  RecyclerView.Adapter<ContactoAdaptador.ContactoViewHolder>{
   ...
   //Inflar el layout y lo pasara al viewholder para el obtenga los views
    ...
    //esto muestra uno a uno  de los items
    ...
    public void onBindViewHolder(@NonNull final ContactoViewHolder contactoViewHolder, int position) {
        ...
        contactoViewHolder.btnLike.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                contactoViewHolder.tvLikes.setText(String.valueOf(constructorContactos.obtenerLikesContactos(contacto)));
...
///primer paso para poder utilizarlo en  el bind
