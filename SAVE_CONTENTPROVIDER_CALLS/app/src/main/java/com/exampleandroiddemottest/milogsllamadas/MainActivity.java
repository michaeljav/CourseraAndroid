package com.exampleandroiddemottest.milogsllamadas;
...
//si el permiso ya fue otorgado
    ...
    public void solicitarPermiso(){
        ...
        if (solicitarPermisoRCL && solicitarPermisoWCL){
            Toast.makeText(MainActivity.this,"Los permisos fuenon otorgados",Toast.LENGTH_SHORT).show();
        }else {
    ...
    //cachar el callback cuando el permiso haya sido asigando
...
//        super.onRequestPermissionsResult(requestCode, permissions, grantResults);
        switch (requestCode){
            case    CODIGO_SOLICITUD_PERMISO:
                //si los permisos ya fueron concedidos
                if (checarStatusPermiso()){
                    Toast.makeText(MainActivity.this,"Ya esta el permiso ",Toast.LENGTH_SHORT).show();
                    //ahora es que podemos consultar el content privider
                    consultarCPLlamadas();
                }else {
    ...
    public void consultarCPLlamadas(){
        ...
        while (registros.moveToNext()){
            //obtenemos los datos a partir del indice de la conlumna
